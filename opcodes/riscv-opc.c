...
const char * const riscv_hwacha_gpr_names[NVGPR] =
{
...
const char * const riscv_hwacha_spr_names[NVSPR] =
{
...
const char * const riscv_hwacha_apr_names[NVAPR] =
{
...
const char * const riscv_hwacha_ppr_names[NVPPR] =
{
...
#define MASK_VVS1 ((insn_t)OP_MASK_VVS1 << OP_SH_VVS1)
...
{"custom2",    0, INSN_CLASS_XCUSTOM, "d,s,t,^j", MATCH_CUSTOM2_RD_RS1_RS2, MASK_CUSTOM2_RD_RS1_RS2, match_opcode, 0},
{"custom2",    0, INSN_CLASS_XCUSTOM, "d,s,^t,^j", MATCH_CUSTOM2_RD_RS1, MASK_CUSTOM2_RD_RS1, match_opcode, 0},
{"custom2",    0, INSN_CLASS_XCUSTOM, "d,^s,^t,^j", MATCH_CUSTOM2_RD, MASK_CUSTOM2_RD, match_opcode, 0},
{"custom2",    0, INSN_CLASS_XCUSTOM, "^d,s,t,^j", MATCH_CUSTOM2_RS1_RS2, MASK_CUSTOM2_RS1_RS2, match_opcode, 0},
{"custom2",    0, INSN_CLASS_XCUSTOM, "^d,s,^t,^j", MATCH_CUSTOM2_RS1, MASK_CUSTOM2_RS1, match_opcode, 0},
{"custom2",    0, INSN_CLASS_XCUSTOM, "^d,^s,^t,^j", MATCH_CUSTOM2, MASK_CUSTOM2, match_opcode, 0},
{"custom3",    0, INSN_CLASS_XCUSTOM, "d,s,t,^j", MATCH_CUSTOM3_RD_RS1_RS2, MASK_CUSTOM3_RD_RS1_RS2, match_opcode, 0},
{"custom3",    0, INSN_CLASS_XCUSTOM, "d,s,^t,^j", MATCH_CUSTOM3_RD_RS1, MASK_CUSTOM3_RD_RS1, match_opcode, 0},
{"custom3",    0, INSN_CLASS_XCUSTOM, "d,^s,^t,^j", MATCH_CUSTOM3_RD, MASK_CUSTOM3_RD, match_opcode, 0},
{"custom3",    0, INSN_CLASS_XCUSTOM, "^d,s,t,^j", MATCH_CUSTOM3_RS1_RS2, MASK_CUSTOM3_RS1_RS2, match_opcode, 0},
{"custom3",    0, INSN_CLASS_XCUSTOM, "^d,s,^t,^j", MATCH_CUSTOM3_RS1, MASK_CUSTOM3_RS1, match_opcode, 0},
{"custom3",    0, INSN_CLASS_XCUSTOM, "^d,^s,^t,^j", MATCH_CUSTOM3, MASK_CUSTOM3, match_opcode, 0},

/* Xhwacha extension control thread instructions */
{"vsetcfg",    0, INSN_CLASS_XHWACHA, "s", MATCH_VSETCFG, MASK_VSETCFG | MASK_IMM, match_opcode, 0},
{"vsetcfg",    0, INSN_CLASS_XHWACHA, "#g,#f", MATCH_VSETCFG, MASK_VSETCFG | MASK_RS1, match_opcode, 0},
...
{"vmcs",       0, INSN_CLASS_XHWACHA, "#E,s", MATCH_VMCS, MASK_VMCS, match_opcode, 0},
{"vmca",       0, INSN_CLASS_XHWACHA, "#e,s", MATCH_VMCA, MASK_VMCA, match_opcode, 0},

{"vf",         0, INSN_CLASS_XHWACHA, "q(s)", MATCH_VF, MASK_VF, match_opcode, 0},
{"vf",         0, INSN_CLASS_XHWACHA, "A,s", 0, (int) M_VF, match_never, INSN_MACRO },

{"vxcptcause",   0, INSN_CLASS_XHWACHA, "d", MATCH_VXCPTCAUSE, MASK_VXCPTCAUSE, match_opcode, 0},
{"vxcptaux",     0, INSN_CLASS_XHWACHA, "d", MATCH_VXCPTAUX, MASK_VXCPTAUX, match_opcode, 0},

{"vxcptsave",    0, INSN_CLASS_XHWACHA, "s", MATCH_VXCPTSAVE, MASK_VXCPTSAVE, match_opcode, 0},
{"vxcptrestore", 0, INSN_CLASS_XHWACHA, "s", MATCH_VXCPTRESTORE, MASK_VXCPTRESTORE, match_opcode, 0},
{"vxcptkill",    0, INSN_CLASS_XHWACHA, "", MATCH_VXCPTKILL, MASK_VXCPTKILL, match_opcode, 0},

{"vxcptevac",    0, INSN_CLASS_XHWACHA, "s", MATCH_VXCPTEVAC, MASK_VXCPTEVAC, match_opcode, 0},
{"vxcpthold",    0, INSN_CLASS_XHWACHA, "s", MATCH_VXCPTHOLD, MASK_VXCPTHOLD, match_opcode, 0},
{"venqcmd",      0, INSN_CLASS_XHWACHA, "s,t", MATCH_VENQCMD, MASK_VENQCMD, match_opcode, 0},
{"venqimm1",     0, INSN_CLASS_XHWACHA, "s,t", MATCH_VENQIMM1, MASK_VENQIMM1, match_opcode, 0},
{"venqimm2",     0, INSN_CLASS_XHWACHA, "s,t", MATCH_VENQIMM2, MASK_VENQIMM2, match_opcode, 0},
{"venqcnt",      0, INSN_CLASS_XHWACHA, "s,t", MATCH_VENQCNT, MASK_VENQCNT, match_opcode, 0},

/* Xhwacha extension worker thread instructions */
{"vstop",      0, INSN_CLASS_XHWACHA, "", MATCH_VSTOP, MASK_VSTOP, match_opcode, 0},
{"vfence",     0, INSN_CLASS_XHWACHA, "#G,#H", MATCH_VFENCE, MASK_VFENCE, match_opcode, 0},
{"vfence",     0, INSN_CLASS_XHWACHA, "",  MATCH_VFENCE | MASK_VPREV | MASK_VSUCC, MASK_VFENCE | MASK_VRD,  match_opcode,   INSN_ALIAS },
{"veidx",      0, INSN_CLASS_XHWACHA, "#N,#p,#d", MATCH_VEIDX, MASK_VEIDX | MASK_VRS1 | MASK_VVS1, match_opcode, INSN_ALIAS},
{"veidx",      0, INSN_CLASS_XHWACHA, "#N,#p,#w,#d,#s", MATCH_VEIDX, MASK_VEIDX, match_opcode, 0},
{"vfirst",     0, INSN_CLASS_XHWACHA, "#N,#p,#D,#s", MATCH_VFIRST, MASK_VFIRST, match_opcode, 0},

/* work thread control flow instructions */
{"vcjal",      0, INSN_CLASS_XHWACHA, "#N,#p,#c,#D,#k", MATCH_VCJAL, MASK_VCJAL, match_opcode, 0},
{"vcjalr",     0, INSN_CLASS_XHWACHA, "#N,#p,#c,#D,#S,#k", MATCH_VCJALR, MASK_VCJALR, match_opcode, 0},

/* scalar load upper */
{"vlui",       0, INSN_CLASS_XHWACHA, "#D,#j", MATCH_VLUI, MASK_VLUI, match_opcode, 0},
{"vauipc",     0, INSN_CLASS_XHWACHA, "#D,#j", MATCH_VAUIPC, MASK_VAUIPC, match_opcode, 0},

/* vnop */
{"vnop",       0, INSN_CLASS_XHWACHA, "",  MATCH_VADDI, MASK_VADDI | MASK_VRD | MASK_VRS1 | MASK_VIMM | MASK_VPRED | MASK_VN, match_opcode,  INSN_ALIAS},

/* vector loads */
/* unit stride */
/* xloads */
{"vld",        0, INSN_CLASS_XHWACHA, "#N,#p,#d,#A", MATCH_VLD, MASK_VLD, match_opcode, 0},
{"vlw",        0, INSN_CLASS_XHWACHA, "#N,#p,#d,#A", MATCH_VLW, MASK_VLW, match_opcode, 0},
{"vlwu",       0, INSN_CLASS_XHWACHA, "#N,#p,#d,#A", MATCH_VLWU, MASK_VLWU, match_opcode, 0},
{"vlh",        0, INSN_CLASS_XHWACHA, "#N,#p,#d,#A", MATCH_VLH, MASK_VLH, match_opcode, 0},
{"vlhu",       0, INSN_CLASS_XHWACHA, "#N,#p,#d,#A", MATCH_VLHU, MASK_VLHU, match_opcode, 0},
{"vlb",        0, INSN_CLASS_XHWACHA, "#N,#p,#d,#A", MATCH_VLB, MASK_VLB, match_opcode, 0},
{"vlbu",       0, INSN_CLASS_XHWACHA, "#N,#p,#d,#A", MATCH_VLBU, MASK_VLBU, match_opcode, 0},

/* stride */
/* xloads */
{"vlstd",      0, INSN_CLASS_XHWACHA, "#N,#p,#d,#A,#B", MATCH_VLSTD, MASK_VLSTD, match_opcode, 0},
{"vlstw",      0, INSN_CLASS_XHWACHA, "#N,#p,#d,#A,#B", MATCH_VLSTW, MASK_VLSTW, match_opcode, 0},
{"vlstwu",     0, INSN_CLASS_XHWACHA, "#N,#p,#d,#A,#B", MATCH_VLSTWU, MASK_VLSTWU, match_opcode, 0},
{"vlsth",      0, INSN_CLASS_XHWACHA, "#N,#p,#d,#A,#B", MATCH_VLSTH, MASK_VLSTH, match_opcode, 0},
{"vlsthu",     0, INSN_CLASS_XHWACHA, "#N,#p,#d,#A,#B", MATCH_VLSTHU, MASK_VLSTHU, match_opcode, 0},
{"vlstb",      0, INSN_CLASS_XHWACHA, "#N,#p,#d,#A,#B", MATCH_VLSTB, MASK_VLSTB, match_opcode, 0},
{"vlstbu",     0, INSN_CLASS_XHWACHA, "#N,#p,#d,#A,#B", MATCH_VLSTBU, MASK_VLSTBU, match_opcode, 0},

/* segment */
/* xloads */
{"vlsegd",     0, INSN_CLASS_XHWACHA, "#N,#p,#d,#A,#n", MATCH_VLSEGD, MASK_VLSEGD, match_opcode, 0},
{"vlsegw",     0, INSN_CLASS_XHWACHA, "#N,#p,#d,#A,#n", MATCH_VLSEGW, MASK_VLSEGW, match_opcode, 0},
{"vlsegwu",    0, INSN_CLASS_XHWACHA, "#N,#p,#d,#A,#n", MATCH_VLSEGWU, MASK_VLSEGWU, match_opcode, 0},
{"vlsegh",     0, INSN_CLASS_XHWACHA, "#N,#p,#d,#A,#n", MATCH_VLSEGH, MASK_VLSEGH, match_opcode, 0},
{"vlseghu",    0, INSN_CLASS_XHWACHA, "#N,#p,#d,#A,#n", MATCH_VLSEGHU, MASK_VLSEGHU, match_opcode, 0},
{"vlsegb",     0, INSN_CLASS_XHWACHA, "#N,#p,#d,#A,#n", MATCH_VLSEGB, MASK_VLSEGB, match_opcode, 0},
{"vlsegbu",    0, INSN_CLASS_XHWACHA, "#N,#p,#d,#A,#n", MATCH_VLSEGBU, MASK_VLSEGBU, match_opcode, 0},

/* stride segment */
/* xloads */
{"vlsegstd",   0, INSN_CLASS_XHWACHA, "#N,#p,#d,#A,#B,#n", MATCH_VLSEGSTD, MASK_VLSEGSTD, match_opcode, 0},
{"vlsegstw",   0, INSN_CLASS_XHWACHA, "#N,#p,#d,#A,#B,#n", MATCH_VLSEGSTW, MASK_VLSEGSTW, match_opcode, 0},
{"vlsegstwu",  0, INSN_CLASS_XHWACHA, "#N,#p,#d,#A,#B,#n", MATCH_VLSEGSTWU, MASK_VLSEGSTWU, match_opcode, 0},
{"vlsegsth",   0, INSN_CLASS_XHWACHA, "#N,#p,#d,#A,#B,#n", MATCH_VLSEGSTH, MASK_VLSEGSTH, match_opcode, 0},
{"vlsegsthu",  0, INSN_CLASS_XHWACHA, "#N,#p,#d,#A,#B,#n", MATCH_VLSEGSTHU, MASK_VLSEGSTHU, match_opcode, 0},
{"vlsegstb",   0, INSN_CLASS_XHWACHA, "#N,#p,#d,#A,#B,#n", MATCH_VLSEGSTB, MASK_VLSEGSTB, match_opcode, 0},
{"vlsegstbu",  0, INSN_CLASS_XHWACHA, "#N,#p,#d,#A,#B,#n", MATCH_VLSEGSTBU, MASK_VLSEGSTBU, match_opcode, 0},

/* unit stride */
/* xstores */
{"vsd",        0, INSN_CLASS_XHWACHA, "#N,#p,#d,#A", MATCH_VSD, MASK_VSD, match_opcode, 0},
{"vsw",        0, INSN_CLASS_XHWACHA, "#N,#p,#d,#A", MATCH_VSW, MASK_VSW, match_opcode, 0},
{"vsh",        0, INSN_CLASS_XHWACHA, "#N,#p,#d,#A", MATCH_VSH, MASK_VSH, match_opcode, 0},
{"vsb",        0, INSN_CLASS_XHWACHA, "#N,#p,#d,#A", MATCH_VSB, MASK_VSB, match_opcode, 0},

/* stride */
/* xstores */
{"vsstd",      0, INSN_CLASS_XHWACHA, "#N,#p,#d,#A,#B", MATCH_VSSTD, MASK_VSSTD, match_opcode, 0},
{"vsstw",      0, INSN_CLASS_XHWACHA, "#N,#p,#d,#A,#B", MATCH_VSSTW, MASK_VSSTW, match_opcode, 0},
{"vssth",      0, INSN_CLASS_XHWACHA, "#N,#p,#d,#A,#B", MATCH_VSSTH, MASK_VSSTH, match_opcode, 0},
{"vsstb",      0, INSN_CLASS_XHWACHA, "#N,#p,#d,#A,#B", MATCH_VSSTB, MASK_VSSTB, match_opcode, 0},

/* segment */
/* xstores */
{"vssegd",     0, INSN_CLASS_XHWACHA, "#N,#p,#d,#A,#n", MATCH_VSSEGD, MASK_VSSEGD, match_opcode, 0},
{"vssegw",     0, INSN_CLASS_XHWACHA, "#N,#p,#d,#A,#n", MATCH_VSSEGW, MASK_VSSEGW, match_opcode, 0},
{"vssegh",     0, INSN_CLASS_XHWACHA, "#N,#p,#d,#A,#n", MATCH_VSSEGH, MASK_VSSEGH, match_opcode, 0},
{"vssegb",     0, INSN_CLASS_XHWACHA, "#N,#p,#d,#A,#n", MATCH_VSSEGB, MASK_VSSEGB, match_opcode, 0},

/* stride segment */
/* xsegstores */
{"vssegstd",   0, INSN_CLASS_XHWACHA, "#N,#p,#d,#A,#B,#n", MATCH_VSSEGSTD, MASK_VSSEGSTD, match_opcode, 0},
{"vssegstw",   0, INSN_CLASS_XHWACHA, "#N,#p,#d,#A,#B,#n", MATCH_VSSEGSTW, MASK_VSSEGSTW, match_opcode, 0},
{"vssegsth",   0, INSN_CLASS_XHWACHA, "#N,#p,#d,#A,#B,#n", MATCH_VSSEGSTH, MASK_VSSEGSTH, match_opcode, 0},
{"vssegstb",   0, INSN_CLASS_XHWACHA, "#N,#p,#d,#A,#B,#n", MATCH_VSSEGSTB, MASK_VSSEGSTB, match_opcode, 0},

/* indexed load/stores */
/* xloads */
{"vlxd",       0, INSN_CLASS_XHWACHA, "#N,#p,#d,#S,#t", MATCH_VLXD, MASK_VLXD, match_opcode, 0},
{"vlxw",       0, INSN_CLASS_XHWACHA, "#N,#p,#d,#S,#t", MATCH_VLXW, MASK_VLXW, match_opcode, 0},
{"vlxwu",      0, INSN_CLASS_XHWACHA, "#N,#p,#d,#S,#t", MATCH_VLXWU,MASK_VLXWU, match_opcode, 0},
{"vlxh",       0, INSN_CLASS_XHWACHA, "#N,#p,#d,#S,#t", MATCH_VLXH, MASK_VLXH, match_opcode, 0},
{"vlxhu",      0, INSN_CLASS_XHWACHA, "#N,#p,#d,#S,#t", MATCH_VLXHU,MASK_VLXHU, match_opcode, 0},
{"vlxb",       0, INSN_CLASS_XHWACHA, "#N,#p,#d,#S,#t", MATCH_VLXB, MASK_VLXB, match_opcode, 0},
{"vlxbu",      0, INSN_CLASS_XHWACHA, "#N,#p,#d,#S,#t", MATCH_VLXBU,MASK_VLXBU, match_opcode, 0},
/* xstores */
{"vsxd",       0, INSN_CLASS_XHWACHA, "#N,#p,#d,#S,#t", MATCH_VSXD, MASK_VSXD, match_opcode, 0},
{"vsxw",       0, INSN_CLASS_XHWACHA, "#N,#p,#d,#S,#t", MATCH_VSXW, MASK_VSXW, match_opcode, 0},
{"vsxh",       0, INSN_CLASS_XHWACHA, "#N,#p,#d,#S,#t", MATCH_VSXH, MASK_VSXH, match_opcode, 0},
{"vsxb",       0, INSN_CLASS_XHWACHA, "#N,#p,#d,#S,#t", MATCH_VSXB, MASK_VSXB, match_opcode, 0},

/* shared loads from shared registers */
/* xloads */
{"vlsd",       0, INSN_CLASS_XHWACHA, "#d,#S", MATCH_VLSD, MASK_VLSD, match_opcode, 0},
{"vlsw",       0, INSN_CLASS_XHWACHA, "#d,#S", MATCH_VLSW, MASK_VLSW, match_opcode, 0},
{"vlswu",      0, INSN_CLASS_XHWACHA, "#d,#S", MATCH_VLSWU,MASK_VLSWU, match_opcode, 0},
{"vlsh",       0, INSN_CLASS_XHWACHA, "#d,#S", MATCH_VLSH, MASK_VLSH, match_opcode, 0},
{"vlshu",      0, INSN_CLASS_XHWACHA, "#d,#S", MATCH_VLSHU,MASK_VLSHU, match_opcode, 0},
{"vlsb",       0, INSN_CLASS_XHWACHA, "#d,#S", MATCH_VLSB, MASK_VLSB, match_opcode, 0},
{"vlsbu",      0, INSN_CLASS_XHWACHA, "#d,#S", MATCH_VLSBU,MASK_VLSBU, match_opcode, 0},
/* xstores */
{"vssd",       0, INSN_CLASS_XHWACHA, "#S,#T", MATCH_VSSD, MASK_VSSD, match_opcode, 0},
{"vssw",       0, INSN_CLASS_XHWACHA, "#S,#T", MATCH_VSSW, MASK_VSSW, match_opcode, 0},
{"vssh",       0, INSN_CLASS_XHWACHA, "#S,#T", MATCH_VSSH, MASK_VSSH, match_opcode, 0},
{"vssb",       0, INSN_CLASS_XHWACHA, "#S,#T", MATCH_VSSB, MASK_VSSB, match_opcode, 0},

/* shared loads from address registers */
/* xloads */
{"vlad",       0, INSN_CLASS_XHWACHA, "#d,#A", MATCH_VLAD, MASK_VLAD, match_opcode, 0},
{"vlaw",       0, INSN_CLASS_XHWACHA, "#d,#A", MATCH_VLAW, MASK_VLAW, match_opcode, 0},
{"vlawu",      0, INSN_CLASS_XHWACHA, "#d,#A", MATCH_VLAWU,MASK_VLAWU, match_opcode, 0},
{"vlah",       0, INSN_CLASS_XHWACHA, "#d,#A", MATCH_VLAH, MASK_VLAH, match_opcode, 0},
{"vlahu",      0, INSN_CLASS_XHWACHA, "#d,#A", MATCH_VLAHU,MASK_VLAHU, match_opcode, 0},
{"vlab",       0, INSN_CLASS_XHWACHA, "#d,#A", MATCH_VLAB, MASK_VLAB, match_opcode, 0},
{"vlabu",      0, INSN_CLASS_XHWACHA, "#d,#A", MATCH_VLABU,MASK_VLABU, match_opcode, 0},
/* xstores */
{"vsad",       0, INSN_CLASS_XHWACHA, "#A,#T", MATCH_VSAD, MASK_VSAD, match_opcode, 0},
{"vsaw",       0, INSN_CLASS_XHWACHA, "#A,#T", MATCH_VSAW, MASK_VSAW, match_opcode, 0},
{"vsah",       0, INSN_CLASS_XHWACHA, "#A,#T", MATCH_VSAH, MASK_VSAH, match_opcode, 0},
{"vsab",       0, INSN_CLASS_XHWACHA, "#A,#T", MATCH_VSAB, MASK_VSAB, match_opcode, 0},

/* Vector-vector ut operations */
{"vandi",      0, INSN_CLASS_XHWACHA, "#d,#s,#j",  MATCH_VANDI, MASK_VANDI, match_opcode,   0 },
{"vand",       0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,#s,#t",  MATCH_VAND, MASK_VAND, match_opcode,   0 },
{"vand",       0, INSN_CLASS_XHWACHA, "#d,#s,#j",  MATCH_VANDI, MASK_VANDI, match_opcode,   INSN_ALIAS },
{"vaddi",      0, INSN_CLASS_XHWACHA, "#d,#s,#j",  MATCH_VADDI, MASK_VADDI, match_opcode,  0 },
{"vadd",       0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,#s,#t",  MATCH_VADD, MASK_VADD, match_opcode,  0 },
{"vadd",       0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,#s,#t,0",MATCH_VADD, MASK_VADD, match_opcode,  0 },
{"vadd",       0, INSN_CLASS_XHWACHA, "#d,#s,#j",  MATCH_VADDI, MASK_VADDI, match_opcode,  INSN_ALIAS },
{"vslli",      0, INSN_CLASS_XHWACHA, "#d,#s,#>",   MATCH_VSLLI, MASK_VSLLI, match_opcode,   0 },
{"vsll",       0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,#s,#t",   MATCH_VSLL, MASK_VSLL, match_opcode,   0 },
{"vsll",       0, INSN_CLASS_XHWACHA, "#d,#s,#>",   MATCH_VSLLI, MASK_VSLLI, match_opcode,   INSN_ALIAS },
{"vsrli",      0, INSN_CLASS_XHWACHA, "#d,#s,#>",   MATCH_VSRLI, MASK_VSRLI, match_opcode,   0 },
{"vsrl",       0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,#s,#t",   MATCH_VSRL, MASK_VSRL, match_opcode,   0 },
{"vsrl",       0, INSN_CLASS_XHWACHA, "#d,#s,#>",   MATCH_VSRLI, MASK_VSRLI, match_opcode,   INSN_ALIAS },
{"vsrai",      0, INSN_CLASS_XHWACHA, "#d,#s,#>",   MATCH_VSRAI, MASK_VSRAI, match_opcode,   0 },
{"vsra",       0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,#s,#t",   MATCH_VSRA, MASK_VSRA, match_opcode,   0 },
{"vsra",       0, INSN_CLASS_XHWACHA, "#d,#s,#>",   MATCH_VSRAI, MASK_VSRAI, match_opcode,   INSN_ALIAS },
{"vsub",       0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,#s,#t",  MATCH_VSUB, MASK_VSUB, match_opcode,   0 },
{"vori",       0, INSN_CLASS_XHWACHA, "#d,#s,#j",  MATCH_VORI, MASK_VORI, match_opcode,   0 },
{"vor",        0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,#s,#t",  MATCH_VOR, MASK_VOR, match_opcode,   0 },
{"vor",        0, INSN_CLASS_XHWACHA, "#d,#s,#j",  MATCH_VORI, MASK_VORI, match_opcode,   INSN_ALIAS },
{"vseqz",      0, INSN_CLASS_XHWACHA, "#d,#s",  MATCH_VSLTIU | ENCODE_ITYPE_VIMM(1), MASK_VSLTIU | MASK_VIMM, match_opcode,   INSN_ALIAS },
{"vsnez",      0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,#t",  MATCH_VSLTU, MASK_VSLTU | MASK_VRS1, match_opcode,   INSN_ALIAS },
{"vsltz",      0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,#s",  MATCH_VSLT, MASK_VSLT | MASK_VRS2, match_opcode,   INSN_ALIAS },
{"vsgtz",      0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,#t",  MATCH_VSLT, MASK_VSLT | MASK_VRS1, match_opcode,   INSN_ALIAS },
{"vslti",      0, INSN_CLASS_XHWACHA, "#d,#s,#j",  MATCH_VSLTI, MASK_VSLTI, match_opcode,   INSN_ALIAS },
{"vslt",       0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,#s,#t",  MATCH_VSLT, MASK_VSLT, match_opcode,   0 },
{"vslt",       0, INSN_CLASS_XHWACHA, "#d,#s,#j",  MATCH_VSLTI, MASK_VSLTI, match_opcode,   0 },
{"vsltiu",     0, INSN_CLASS_XHWACHA, "#d,#s,#j",  MATCH_VSLTIU, MASK_VSLTIU, match_opcode,   0 },
{"vsltu",      0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,#s,#t",  MATCH_VSLTU, MASK_VSLTU, match_opcode,   0 },
{"vsltu",      0, INSN_CLASS_XHWACHA, "#d,#s,#j",  MATCH_VSLTIU, MASK_VSLTIU, match_opcode,   INSN_ALIAS },
{"vsgt",       0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,#t,#s",  MATCH_VSLT, MASK_VSLT, match_opcode,   INSN_ALIAS },
{"vsgtu",      0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,#t,#s",  MATCH_VSLTU, MASK_VSLTU, match_opcode,   INSN_ALIAS },
{"vxori",      0, INSN_CLASS_XHWACHA, "#d,#s,#j",  MATCH_VXORI, MASK_VXORI, match_opcode,   0 },
{"vxor",       0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,#s,#t",  MATCH_VXOR, MASK_VXOR, match_opcode,   0 },
{"vxor",       0, INSN_CLASS_XHWACHA, "#d,#s,#j",  MATCH_VXORI, MASK_VXORI, match_opcode,   INSN_ALIAS },
{"vsext.w",    0, INSN_CLASS_XHWACHA, "#d,#s",  MATCH_VADDIW, MASK_VADDIW | MASK_VIMM, match_opcode,   INSN_ALIAS },
{"vaddiw",     0, INSN_CLASS_XHWACHA, "#d,#s,#j",  MATCH_VADDIW, MASK_VADDIW, match_opcode,   0 },
{"vaddw",      0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,#s,#t",  MATCH_VADDW, MASK_VADDW, match_opcode,   0 },
{"vaddw",      0, INSN_CLASS_XHWACHA, "#d,#s,#j",  MATCH_VADDIW, MASK_VADDIW, match_opcode,   INSN_ALIAS },
{"vnegw",      0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,#t",  MATCH_VSUBW, MASK_VSUBW | MASK_VRS1, match_opcode,   INSN_ALIAS }, /* sub 0 */
{"vslliw",     0, INSN_CLASS_XHWACHA, "#d,#s,#<",   MATCH_VSLLIW, MASK_VSLLIW, match_opcode,   0 },
{"vsllw",      0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,#s,#t",   MATCH_VSLLW, MASK_VSLLW, match_opcode,   0 },
{"vsllw",      0, INSN_CLASS_XHWACHA, "#d,#s,#<",   MATCH_VSLLIW, MASK_VSLLIW, match_opcode,   INSN_ALIAS },
{"vsrliw",     0, INSN_CLASS_XHWACHA, "#d,#s,#<",   MATCH_VSRLIW, MASK_VSRLIW, match_opcode,   0 },
{"vsrlw",      0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,#s,#t",   MATCH_VSRLW, MASK_VSRLW, match_opcode,   0 },
{"vsrlw",      0, INSN_CLASS_XHWACHA, "#d,#s,#<",   MATCH_VSRLIW, MASK_VSRLIW, match_opcode,   INSN_ALIAS },
{"vsraiw",     0, INSN_CLASS_XHWACHA, "#d,#s,#<",   MATCH_VSRAIW, MASK_VSRAIW, match_opcode,   0 },
{"vsraw",      0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,#s,#t",   MATCH_VSRAW, MASK_VSRAW, match_opcode,   0 },
{"vsraw",      0, INSN_CLASS_XHWACHA, "#d,#s,#<",   MATCH_VSRAIW, MASK_VSRAIW, match_opcode,   INSN_ALIAS },
{"vsubw",      0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,#s,#t",  MATCH_VSUBW, MASK_VSUBW, match_opcode,   0 },

/* Vector Comparison worker-thread operations */
{"vcmpeq",     0, INSN_CLASS_XHWACHA, "#N,#p,#x,#F,#s,#t",    MATCH_VCMPEQ, MASK_VCMPEQ, match_opcode,  0 },
{"vcmplt",     0, INSN_CLASS_XHWACHA, "#N,#p,#x,#F,#s,#t",    MATCH_VCMPLT, MASK_VCMPLT, match_opcode,  0 },
{"vcmpltu",    0, INSN_CLASS_XHWACHA, "#N,#p,#x,#F,#s,#t",    MATCH_VCMPLTU, MASK_VCMPLTU, match_opcode,  0 },

/* Vector predicate register load/stores */
{"vpl",        0, INSN_CLASS_XHWACHA, "#N,#p,#F,#A", MATCH_VPL, MASK_VPL, match_opcode, 0},
{"vps",        0, INSN_CLASS_XHWACHA, "#N,#p,#P,#A", MATCH_VPS, MASK_VPS, match_opcode, 0},

/* Vector predicate register arithmetic */
{"vpop",       0, INSN_CLASS_XHWACHA,   "#F,#O,#P,#Q,#z", MATCH_VPOP, MASK_VPOP, match_opcode, 0 },
{"vpclear",    0, INSN_CLASS_XHWACHA,   "#F",    MATCH_VPCLEAR, MASK_VPCLEAR, match_opcode, 0 },
{"vpset",      0, INSN_CLASS_XHWACHA,   "#F",    MATCH_VPSET, MASK_VPSET, match_opcode, 0 },
{"vpxorxor",   0, INSN_CLASS_XHWACHA,   "#F,#O,#P,#Q",    MATCH_VPXORXOR, MASK_VPXORXOR, match_opcode, 0 },
{"vpxorand",   0, INSN_CLASS_XHWACHA,   "#F,#O,#P,#Q",    MATCH_VPXORAND, MASK_VPXORAND, match_opcode, 0 },
{"vpxoror",    0, INSN_CLASS_XHWACHA,   "#F,#O,#P,#Q",    MATCH_VPXOROR, MASK_VPXOROR, match_opcode, 0 },
{"vpandxor",   0, INSN_CLASS_XHWACHA,   "#F,#O,#P,#Q",    MATCH_VPANDXOR, MASK_VPANDXOR, match_opcode, 0 },
{"vpandand",   0, INSN_CLASS_XHWACHA,   "#F,#O,#P,#Q",    MATCH_VPANDAND, MASK_VPANDAND, match_opcode, 0 },
{"vpandor",    0, INSN_CLASS_XHWACHA,   "#F,#O,#P,#Q",    MATCH_VPANDOR, MASK_VPANDOR, match_opcode, 0 },
{"vporxor",    0, INSN_CLASS_XHWACHA,   "#F,#O,#P,#Q",    MATCH_VPORXOR, MASK_VPORXOR, match_opcode, 0 },
{"vporand",    0, INSN_CLASS_XHWACHA,   "#F,#O,#P,#Q",    MATCH_VPORAND, MASK_VPORAND, match_opcode, 0 },
{"vporor",     0, INSN_CLASS_XHWACHA,   "#F,#O,#P,#Q",    MATCH_VPOROR, MASK_VPOROR, match_opcode, 0 },

/* Atomic memory operation instruction subset */
{"vamoadd.w",      0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOADD_W, MASK_VAMOADD_W | MASK_VAQRL, match_opcode,   0 },
{"vamoswap.w",     0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOSWAP_W, MASK_VAMOSWAP_W | MASK_VAQRL, match_opcode,   0 },
{"vamoand.w",      0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOAND_W, MASK_VAMOAND_W | MASK_VAQRL, match_opcode,   0 },
{"vamoor.w",       0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOOR_W, MASK_VAMOOR_W | MASK_VAQRL, match_opcode,   0 },
{"vamoxor.w",      0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOXOR_W, MASK_VAMOXOR_W | MASK_VAQRL, match_opcode,   0 },
{"vamomax.w",      0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOMAX_W, MASK_VAMOMAX_W | MASK_VAQRL, match_opcode,   0 },
{"vamomaxu.w",     0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOMAXU_W, MASK_VAMOMAXU_W | MASK_VAQRL, match_opcode,   0 },
{"vamomin.w",      0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOMIN_W, MASK_VAMOMIN_W | MASK_VAQRL, match_opcode,   0 },
{"vamominu.w",     0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOMINU_W, MASK_VAMOMINU_W | MASK_VAQRL, match_opcode,   0 },
{"vamoadd.w.aq",   0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOADD_W | MASK_VAQ, MASK_VAMOADD_W | MASK_VAQRL, match_opcode,   0 },
{"vamoswap.w.aq",  0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOSWAP_W | MASK_VAQ, MASK_VAMOSWAP_W | MASK_VAQRL, match_opcode,   0 },
{"vamoand.w.aq",   0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOAND_W | MASK_VAQ, MASK_VAMOAND_W | MASK_VAQRL, match_opcode,   0 },
{"vamoor.w.aq",    0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOOR_W | MASK_VAQ, MASK_VAMOOR_W | MASK_VAQRL, match_opcode,   0 },
{"vamoxor.w.aq",   0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOXOR_W | MASK_VAQ, MASK_VAMOXOR_W | MASK_VAQRL, match_opcode,   0 },
{"vamomax.w.aq",   0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOMAX_W | MASK_VAQ, MASK_VAMOMAX_W | MASK_VAQRL, match_opcode,   0 },
{"vamomaxu.w.aq",  0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOMAXU_W | MASK_VAQ, MASK_VAMOMAXU_W | MASK_VAQRL, match_opcode,   0 },
{"vamomin.w.aq",   0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOMIN_W | MASK_VAQ, MASK_VAMOMIN_W | MASK_VAQRL, match_opcode,   0 },
{"vamominu.w.aq",  0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOMINU_W | MASK_VAQ, MASK_VAMOMINU_W | MASK_VAQRL, match_opcode,   0 },
{"vamoadd.w.rl",   0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOADD_W | MASK_VRL, MASK_VAMOADD_W | MASK_VAQRL, match_opcode,   0 },
{"vamoswap.w.rl",  0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOSWAP_W | MASK_VRL, MASK_VAMOSWAP_W | MASK_VAQRL, match_opcode,   0 },
{"vamoand.w.rl",   0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOAND_W | MASK_VRL, MASK_VAMOAND_W | MASK_VAQRL, match_opcode,   0 },
{"vamoor.w.rl",    0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOOR_W | MASK_VRL, MASK_VAMOOR_W | MASK_VAQRL, match_opcode,   0 },
{"vamoxor.w.rl",   0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOXOR_W | MASK_VRL, MASK_VAMOXOR_W | MASK_VAQRL, match_opcode,   0 },
{"vamomax.w.rl",   0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOMAX_W | MASK_VRL, MASK_VAMOMAX_W | MASK_VAQRL, match_opcode,   0 },
{"vamomaxu.w.rl",  0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOMAXU_W | MASK_VRL, MASK_VAMOMAXU_W | MASK_VAQRL, match_opcode,   0 },
{"vamomin.w.rl",   0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOMIN_W | MASK_VRL, MASK_VAMOMIN_W | MASK_VAQRL, match_opcode,   0 },
{"vamominu.w.rl",  0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOMINU_W | MASK_VRL, MASK_VAMOMINU_W | MASK_VAQRL, match_opcode,   0 },
{"vamoadd.w.sc",   0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOADD_W | MASK_VAQRL, MASK_VAMOADD_W | MASK_VAQRL, match_opcode,   0 },
{"vamoswap.w.sc",  0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOSWAP_W | MASK_VAQRL, MASK_VAMOSWAP_W | MASK_VAQRL, match_opcode,   0 },
{"vamoand.w.sc",   0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOAND_W | MASK_VAQRL, MASK_VAMOAND_W | MASK_VAQRL, match_opcode,   0 },
{"vamoor.w.sc",    0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOOR_W | MASK_VAQRL, MASK_VAMOOR_W | MASK_VAQRL, match_opcode,   0 },
{"vamoxor.w.sc",   0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOXOR_W | MASK_VAQRL, MASK_VAMOXOR_W | MASK_VAQRL, match_opcode,   0 },
{"vamomax.w.sc",   0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOMAX_W | MASK_VAQRL, MASK_VAMOMAX_W | MASK_VAQRL, match_opcode,   0 },
{"vamomaxu.w.sc",  0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOMAXU_W | MASK_VAQRL, MASK_VAMOMAXU_W | MASK_VAQRL, match_opcode,   0 },
{"vamomin.w.sc",   0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOMIN_W | MASK_VAQRL, MASK_VAMOMIN_W | MASK_VAQRL, match_opcode,   0 },
{"vamominu.w.sc",  0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOMINU_W | MASK_VAQRL, MASK_VAMOMINU_W | MASK_VAQRL, match_opcode,   0 },
{"vamoadd.d",      0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOADD_D, MASK_VAMOADD_D | MASK_VAQRL, match_opcode,   0 },
{"vamoswap.d",     0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOSWAP_D, MASK_VAMOSWAP_D | MASK_VAQRL, match_opcode,   0 },
{"vamoand.d",      0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOAND_D, MASK_VAMOAND_D | MASK_VAQRL, match_opcode,   0 },
{"vamoor.d",       0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOOR_D, MASK_VAMOOR_D | MASK_VAQRL, match_opcode,   0 },
{"vamoxor.d",      0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOXOR_D, MASK_VAMOXOR_D | MASK_VAQRL, match_opcode,   0 },
{"vamomax.d",      0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOMAX_D, MASK_VAMOMAX_D | MASK_VAQRL, match_opcode,   0 },
{"vamomaxu.d",     0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOMAXU_D, MASK_VAMOMAXU_D | MASK_VAQRL, match_opcode,   0 },
{"vamomin.d",      0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOMIN_D, MASK_VAMOMIN_D | MASK_VAQRL, match_opcode,   0 },
{"vamominu.d",     0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOMINU_D, MASK_VAMOMINU_D | MASK_VAQRL, match_opcode,   0 },
{"vamoadd.d.aq",   0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOADD_D | MASK_VAQ, MASK_VAMOADD_D | MASK_VAQRL, match_opcode,   0 },
{"vamoswap.d.aq",  0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOSWAP_D | MASK_VAQ, MASK_VAMOSWAP_D | MASK_VAQRL, match_opcode,   0 },
{"vamoand.d.aq",   0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOAND_D | MASK_VAQ, MASK_VAMOAND_D | MASK_VAQRL, match_opcode,   0 },
{"vamoor.d.aq",    0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOOR_D | MASK_VAQ, MASK_VAMOOR_D | MASK_VAQRL, match_opcode,   0 },
{"vamoxor.d.aq",   0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOXOR_D | MASK_VAQ, MASK_VAMOXOR_D | MASK_VAQRL, match_opcode,   0 },
{"vamomax.d.aq",   0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOMAX_D | MASK_VAQ, MASK_VAMOMAX_D | MASK_VAQRL, match_opcode,   0 },
{"vamomaxu.d.aq",  0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOMAXU_D | MASK_VAQ, MASK_VAMOMAXU_D | MASK_VAQRL, match_opcode,   0 },
{"vamomin.d.aq",   0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOMIN_D | MASK_VAQ, MASK_VAMOMIN_D | MASK_VAQRL, match_opcode,   0 },
{"vamominu.d.aq",  0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOMINU_D | MASK_VAQ, MASK_VAMOMINU_D | MASK_VAQRL, match_opcode,   0 },
{"vamoadd.d.rl",   0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOADD_D | MASK_VRL, MASK_VAMOADD_D | MASK_VAQRL, match_opcode,   0 },
{"vamoswap.d.rl",  0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOSWAP_D | MASK_VRL, MASK_VAMOSWAP_D | MASK_VAQRL, match_opcode,   0 },
{"vamoand.d.rl",   0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOAND_D | MASK_VRL, MASK_VAMOAND_D | MASK_VAQRL, match_opcode,   0 },
{"vamoor.d.rl",    0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOOR_D | MASK_VRL, MASK_VAMOOR_D | MASK_VAQRL, match_opcode,   0 },
{"vamoxor.d.rl",   0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOXOR_D | MASK_VRL, MASK_VAMOXOR_D | MASK_VAQRL, match_opcode,   0 },
{"vamomax.d.rl",   0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOMAX_D | MASK_VRL, MASK_VAMOMAX_D | MASK_VAQRL, match_opcode,   0 },
{"vamomaxu.d.rl",  0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOMAXU_D | MASK_VRL, MASK_VAMOMAXU_D | MASK_VAQRL, match_opcode,   0 },
{"vamomin.d.rl",   0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOMIN_D | MASK_VRL, MASK_VAMOMIN_D | MASK_VAQRL, match_opcode,   0 },
{"vamominu.d.rl",  0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOMINU_D | MASK_VRL, MASK_VAMOMINU_D | MASK_VAQRL, match_opcode,   0 },
{"vamoadd.d.sc",   0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOADD_D | MASK_VAQRL, MASK_VAMOADD_D | MASK_VAQRL, match_opcode,   0 },
{"vamoswap.d.sc",  0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOSWAP_D | MASK_VAQRL, MASK_VAMOSWAP_D | MASK_VAQRL, match_opcode,   0 },
{"vamoand.d.sc",   0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOAND_D | MASK_VAQRL, MASK_VAMOAND_D | MASK_VAQRL, match_opcode,   0 },
{"vamoor.d.sc",    0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOOR_D | MASK_VAQRL, MASK_VAMOOR_D | MASK_VAQRL, match_opcode,   0 },
{"vamoxor.d.sc",   0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOXOR_D | MASK_VAQRL, MASK_VAMOXOR_D | MASK_VAQRL, match_opcode,   0 },
{"vamomax.d.sc",   0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOMAX_D | MASK_VAQRL, MASK_VAMOMAX_D | MASK_VAQRL, match_opcode,   0 },
{"vamomaxu.d.sc",  0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOMAXU_D | MASK_VAQRL, MASK_VAMOMAXU_D | MASK_VAQRL, match_opcode,   0 },
{"vamomin.d.sc",   0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOMIN_D | MASK_VAQRL, MASK_VAMOMIN_D | MASK_VAQRL, match_opcode,   0 },
{"vamominu.d.sc",  0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOMINU_D | MASK_VAQRL, MASK_VAMOMINU_D | MASK_VAQRL, match_opcode,   0 },

/* Multiply/Divide instruction subset */
{"vmul",        0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,#s,#t",  MATCH_VMUL, MASK_VMUL, match_opcode,  0 },
{"vmulh",       0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,#s,#t",  MATCH_VMULH, MASK_VMULH, match_opcode,  0 },
{"vmulhu",      0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,#s,#t",  MATCH_VMULHU, MASK_VMULHU, match_opcode,  0 },
{"vmulhsu",     0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,#s,#t",  MATCH_VMULHSU, MASK_VMULHSU, match_opcode,  0 },
{"vdiv",        0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,#s,#t",  MATCH_VDIV, MASK_VDIV, match_opcode,  0 },
{"vdivu",       0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,#s,#t",  MATCH_VDIVU, MASK_VDIVU, match_opcode,  0 },
{"vrem",        0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,#s,#t",  MATCH_VREM, MASK_VREM, match_opcode,  0 },
{"vremu",       0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,#s,#t",  MATCH_VREMU, MASK_VREMU, match_opcode,  0 },
{"vmulw",       0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,#s,#t",  MATCH_VMULW, MASK_VMULW, match_opcode,  0 },
{"vdivw",       0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,#s,#t",  MATCH_VDIVW, MASK_VDIVW, match_opcode,  0 },
{"vdivuw",      0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,#s,#t",  MATCH_VDIVUW, MASK_VDIVUW, match_opcode,  0 },
{"vremw",       0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,#s,#t",  MATCH_VREMW, MASK_VREMW, match_opcode,  0 },
{"vremuw",      0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,#s,#t",  MATCH_VREMUW, MASK_VREMUW, match_opcode,  0 },

/* Single-precision floating-point instruction subset */
{"vfmv.s",      0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,#u",  MATCH_VFSGNJ_S, MASK_VFSGNJ_S, match_rs1_eq_rs2,   INSN_ALIAS },
{"vfneg.s",     0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,#u",  MATCH_VFSGNJN_S, MASK_VFSGNJN_S, match_rs1_eq_rs2,   INSN_ALIAS },
{"vfabs.s",     0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,#u",  MATCH_VFSGNJX_S, MASK_VFSGNJX_S, match_rs1_eq_rs2,   INSN_ALIAS },
{"vfsgnj.s",    0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,#s,#t",  MATCH_VFSGNJ_S, MASK_VFSGNJ_S, match_opcode,   0 },
{"vfsgnjn.s",   0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,#s,#t",  MATCH_VFSGNJN_S, MASK_VFSGNJN_S, match_opcode,   0 },
{"vfsgnjx.s",   0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,#s,#t",  MATCH_VFSGNJX_S, MASK_VFSGNJX_S, match_opcode,   0 },
{"vfadd.s",     0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,#s,#t",  MATCH_VFADD_S | MASK_VRM, MASK_VFADD_S | MASK_VRM, match_opcode,   0 },
{"vfadd.s",     0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,#s,#t,#m",  MATCH_VFADD_S, MASK_VFADD_S, match_opcode,   0 },
{"vfsub.s",     0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,#s,#t",  MATCH_VFSUB_S | MASK_VRM, MASK_VFSUB_S | MASK_VRM, match_opcode,   0 },
{"vfsub.s",     0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,#s,#t,#m",  MATCH_VFSUB_S, MASK_VFSUB_S, match_opcode,   0 },
{"vfmul.s",     0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,#s,#t",  MATCH_VFMUL_S | MASK_VRM, MASK_VFMUL_S | MASK_VRM, match_opcode,   0 },
{"vfmul.s",     0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,#s,#t,#m",  MATCH_VFMUL_S, MASK_VFMUL_S, match_opcode,   0 },
{"vfdiv.s",     0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,#s,#t",  MATCH_VFDIV_S | MASK_VRM, MASK_VFDIV_S | MASK_VRM, match_opcode,   0 },
{"vfdiv.s",     0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,#s,#t,#m",  MATCH_VFDIV_S, MASK_VFDIV_S, match_opcode,   0 },
{"vfsqrt.s",    0, INSN_CLASS_XHWACHA, "#N,#p,#v,#w,#d,#s",  MATCH_VFSQRT_S | MASK_VRM, MASK_VFSQRT_S | MASK_VRM, match_opcode,  0 },
{"vfsqrt.s",    0, INSN_CLASS_XHWACHA, "#N,#p,#v,#w,#d,#s,#m",  MATCH_VFSQRT_S, MASK_VFSQRT_S, match_opcode,  0 },
{"vfmin.s",     0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,#s,#t",  MATCH_VFMIN_S, MASK_VFMIN_S, match_opcode,   0 },
{"vfmax.s",     0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,#s,#t",  MATCH_VFMAX_S, MASK_VFMAX_S, match_opcode,   0 },
{"vfmadd.s",    0, INSN_CLASS_XHWACHA, "#N,#p,#v,#y,#d,#s,#t,#r",  MATCH_VFMADD_S | MASK_VRM, MASK_VFMADD_S | MASK_VRM, match_opcode,   0 },
{"vfmadd.s",    0, INSN_CLASS_XHWACHA, "#N,#p,#v,#y,#d,#s,#t,#r,#m",  MATCH_VFMADD_S, MASK_VFMADD_S, match_opcode,   0 },
{"vfnmadd.s",   0, INSN_CLASS_XHWACHA, "#N,#p,#v,#y,#d,#s,#t,#r",  MATCH_VFNMADD_S | MASK_VRM, MASK_VFNMADD_S | MASK_VRM, match_opcode,   0 },
{"vfnmadd.s",   0, INSN_CLASS_XHWACHA, "#N,#p,#v,#y,#d,#s,#t,#r,#m",  MATCH_VFNMADD_S, MASK_VFNMADD_S, match_opcode,   0 },
{"vfmsub.s",    0, INSN_CLASS_XHWACHA, "#N,#p,#v,#y,#d,#s,#t,#r",  MATCH_VFMSUB_S | MASK_VRM, MASK_VFMSUB_S | MASK_VRM, match_opcode,   0 },
{"vfmsub.s",    0, INSN_CLASS_XHWACHA, "#N,#p,#v,#y,#d,#s,#t,#r,#m",  MATCH_VFMSUB_S, MASK_VFMSUB_S, match_opcode,   0 },
{"vfnmsub.s",   0, INSN_CLASS_XHWACHA, "#N,#p,#v,#y,#d,#s,#t,#r",  MATCH_VFNMSUB_S | MASK_VRM, MASK_VFNMSUB_S | MASK_VRM, match_opcode,   0 },
{"vfnmsub.s",   0, INSN_CLASS_XHWACHA, "#N,#p,#v,#y,#d,#s,#t,#r,#m",  MATCH_VFNMSUB_S, MASK_VFNMSUB_S, match_opcode,   0 },
{"vfclass.s",   0, INSN_CLASS_XHWACHA, "#N,#p,#v,#w,#d,#s",  MATCH_VFCLASS_S, MASK_VFCLASS_S, match_opcode,   0 },
{"vcmpfeq.s",   0, INSN_CLASS_XHWACHA, "#N,#p,#x,#F,#s,#t",    MATCH_VCMPFEQ_S, MASK_VCMPFEQ_S, match_opcode,  0 },
{"vcmpflt.s",   0, INSN_CLASS_XHWACHA, "#N,#p,#x,#F,#s,#t",    MATCH_VCMPFLT_S, MASK_VCMPFLT_S, match_opcode,  0 },
{"vcmpfle.s",   0, INSN_CLASS_XHWACHA, "#N,#p,#x,#F,#s,#t",    MATCH_VCMPFLE_S, MASK_VCMPFLE_S, match_opcode,  0 },
{"vcmpfgt.s",   0, INSN_CLASS_XHWACHA, "#N,#p,#x,#F,#t,#s",    MATCH_VCMPFLT_S, MASK_VCMPFLT_S, match_opcode,  0 },
{"vcmpfge.s",   0, INSN_CLASS_XHWACHA, "#N,#p,#x,#F,#t,#s",    MATCH_VCMPFLE_S, MASK_VCMPFLE_S, match_opcode,  0 },
{"vfcvt.w.s",   0, INSN_CLASS_XHWACHA, "#N,#p,#v,#w,#d,#s",     MATCH_VFCVT_W_S | MASK_VRM, MASK_VFCVT_W_S | MASK_VRM, match_opcode,  0 },
{"vfcvt.w.s",   0, INSN_CLASS_XHWACHA, "#N,#p,#v,#w,#d,#s,#m",  MATCH_VFCVT_W_S, MASK_VFCVT_W_S, match_opcode,  0 },
{"vfcvt.wu.s",  0, INSN_CLASS_XHWACHA, "#N,#p,#v,#w,#d,#s",     MATCH_VFCVT_WU_S | MASK_VRM, MASK_VFCVT_WU_S | MASK_VRM, match_opcode,  0 },
{"vfcvt.wu.s",  0, INSN_CLASS_XHWACHA, "#N,#p,#v,#w,#d,#s,#m",  MATCH_VFCVT_WU_S, MASK_VFCVT_WU_S, match_opcode,  0 },
{"vfcvt.s.w",   0, INSN_CLASS_XHWACHA, "#N,#p,#v,#w,#d,#s",     MATCH_VFCVT_S_W | MASK_VRM, MASK_VFCVT_S_W | MASK_VRM, match_opcode,   0 },
{"vfcvt.s.w",   0, INSN_CLASS_XHWACHA, "#N,#p,#v,#w,#d,#s,#m",  MATCH_VFCVT_S_W, MASK_VFCVT_S_W, match_opcode,   0 },
{"vfcvt.s.wu",  0, INSN_CLASS_XHWACHA, "#N,#p,#v,#w,#d,#s",     MATCH_VFCVT_S_WU | MASK_VRM, MASK_VFCVT_S_W | MASK_VRM, match_opcode,   0 },
{"vfcvt.s.wu",  0, INSN_CLASS_XHWACHA, "#N,#p,#v,#w,#d,#s,#m",  MATCH_VFCVT_S_WU, MASK_VFCVT_S_WU, match_opcode,   0 },
{"vfcvt.l.s",   0, INSN_CLASS_XHWACHA, "#N,#p,#v,#w,#d,#s",     MATCH_VFCVT_L_S | MASK_VRM, MASK_VFCVT_L_S | MASK_VRM, match_opcode,  0 },
{"vfcvt.l.s",   0, INSN_CLASS_XHWACHA, "#N,#p,#v,#w,#d,#s,#m",  MATCH_VFCVT_L_S, MASK_VFCVT_L_S, match_opcode,  0 },
{"vfcvt.lu.s",  0, INSN_CLASS_XHWACHA, "#N,#p,#v,#w,#d,#s",     MATCH_VFCVT_LU_S | MASK_VRM, MASK_VFCVT_LU_S | MASK_VRM, match_opcode,  0 },
{"vfcvt.lu.s",  0, INSN_CLASS_XHWACHA, "#N,#p,#v,#w,#d,#s,#m",  MATCH_VFCVT_LU_S, MASK_VFCVT_LU_S, match_opcode,  0 },
{"vfcvt.s.l",   0, INSN_CLASS_XHWACHA, "#N,#p,#v,#w,#d,#s",     MATCH_VFCVT_S_L | MASK_VRM, MASK_VFCVT_S_L | MASK_VRM, match_opcode,   0 },
{"vfcvt.s.l",   0, INSN_CLASS_XHWACHA, "#N,#p,#v,#w,#d,#s,#m",  MATCH_VFCVT_S_L, MASK_VFCVT_S_L, match_opcode,   0 },
{"vfcvt.s.lu",  0, INSN_CLASS_XHWACHA, "#N,#p,#v,#w,#d,#s",     MATCH_VFCVT_S_LU | MASK_VRM, MASK_VFCVT_S_L | MASK_VRM, match_opcode,   0 },
{"vfcvt.s.lu",  0, INSN_CLASS_XHWACHA, "#N,#p,#v,#w,#d,#s,#m",  MATCH_VFCVT_S_LU, MASK_VFCVT_S_LU, match_opcode,   0 },

/* Double-precision floating-point instruction subset */
{"vfmv.d",      0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,#u",  MATCH_VFSGNJ_D, MASK_VFSGNJ_D, match_rs1_eq_rs2,   INSN_ALIAS },
{"vfneg.d",     0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,#u",  MATCH_VFSGNJN_D, MASK_VFSGNJN_D, match_rs1_eq_rs2,   INSN_ALIAS },
{"vfabs.d",     0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,#u",  MATCH_VFSGNJX_D, MASK_VFSGNJX_D, match_rs1_eq_rs2,   INSN_ALIAS },
{"vfsgnj.d",    0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,#s,#t",  MATCH_VFSGNJ_D, MASK_VFSGNJ_D, match_opcode,   0 },
{"vfsgnjn.d",   0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,#s,#t",  MATCH_VFSGNJN_D, MASK_VFSGNJN_D, match_opcode,   0 },
{"vfsgnjx.d",   0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,#s,#t",  MATCH_VFSGNJX_D, MASK_VFSGNJX_D, match_opcode,   0 },
{"vfadd.d",     0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,#s,#t",  MATCH_VFADD_D | MASK_VRM, MASK_VFADD_D | MASK_VRM, match_opcode,   0 },
{"vfadd.d",     0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,#s,#t,#m",  MATCH_VFADD_D, MASK_VFADD_D, match_opcode,   0 },
{"vfsub.d",     0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,#s,#t",  MATCH_VFSUB_D | MASK_VRM, MASK_VFSUB_D | MASK_VRM, match_opcode,   0 },
{"vfsub.d",     0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,#s,#t,#m",  MATCH_VFSUB_D, MASK_VFSUB_D, match_opcode,   0 },
{"vfmul.d",     0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,#s,#t",  MATCH_VFMUL_D | MASK_VRM, MASK_VFMUL_D | MASK_VRM, match_opcode,   0 },
{"vfmul.d",     0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,#s,#t,#m",  MATCH_VFMUL_D, MASK_VFMUL_D, match_opcode,   0 },
{"vfdiv.d",     0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,#s,#t",  MATCH_VFDIV_D | MASK_VRM, MASK_VFDIV_D | MASK_VRM, match_opcode,   0 },
{"vfdiv.d",     0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,#s,#t,#m",  MATCH_VFDIV_D, MASK_VFDIV_D, match_opcode,   0 },
{"vfsqrt.d",    0, INSN_CLASS_XHWACHA, "#N,#p,#v,#w,#d,#s",  MATCH_VFSQRT_D | MASK_VRM, MASK_VFSQRT_D | MASK_VRM, match_opcode,  0 },
{"vfsqrt.d",    0, INSN_CLASS_XHWACHA, "#N,#p,#v,#w,#d,#s,#m",  MATCH_VFSQRT_D, MASK_VFSQRT_D, match_opcode,  0 },
{"vfmin.d",     0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,#s,#t",  MATCH_VFMIN_D, MASK_VFMIN_D, match_opcode,   0 },
{"vfmax.d",     0, INSN_CLASS_XHWACHA, "#N,#p,#v,#x,#d,#s,#t",  MATCH_VFMAX_D, MASK_VFMAX_D, match_opcode,   0 },
{"vfmadd.d",    0, INSN_CLASS_XHWACHA, "#N,#p,#v,#y,#d,#s,#t,#r",  MATCH_VFMADD_D | MASK_VRM, MASK_VFMADD_D | MASK_VRM, match_opcode,   0 },
{"vfmadd.d",    0, INSN_CLASS_XHWACHA, "#N,#p,#v,#y,#d,#s,#t,#r,#m",  MATCH_VFMADD_D, MASK_VFMADD_D, match_opcode,   0 },
{"vfnmadd.d",   0, INSN_CLASS_XHWACHA, "#N,#p,#v,#y,#d,#s,#t,#r",  MATCH_VFNMADD_D | MASK_VRM, MASK_VFNMADD_D | MASK_VRM, match_opcode,   0 },
{"vfnmadd.d",   0, INSN_CLASS_XHWACHA, "#N,#p,#v,#y,#d,#s,#t,#r,#m",  MATCH_VFNMADD_D, MASK_VFNMADD_D, match_opcode,   0 },
{"vfmsub.d",    0, INSN_CLASS_XHWACHA, "#N,#p,#v,#y,#d,#s,#t,#r",  MATCH_VFMSUB_D | MASK_VRM, MASK_VFMSUB_D | MASK_VRM, match_opcode,   0 },
{"vfmsub.d",    0, INSN_CLASS_XHWACHA, "#N,#p,#v,#y,#d,#s,#t,#r,#m",  MATCH_VFMSUB_D, MASK_VFMSUB_D, match_opcode,   0 },
{"vfnmsub.d",   0, INSN_CLASS_XHWACHA, "#N,#p,#v,#y,#d,#s,#t,#r",  MATCH_VFNMSUB_D | MASK_VRM, MASK_VFNMSUB_D | MASK_VRM, match_opcode,   0 },
{"vfnmsub.d",   0, INSN_CLASS_XHWACHA, "#N,#p,#v,#y,#d,#s,#t,#r,#m",  MATCH_VFNMSUB_D, MASK_VFNMSUB_D, match_opcode,   0 },
{"vfcvt.d.s",   0, INSN_CLASS_XHWACHA, "#N,#p,#v,#w,#d,#s",  MATCH_VFCVT_D_S, MASK_VFCVT_D_S | MASK_VRM, match_opcode,   0 },
{"vfcvt.s.d",   0, INSN_CLASS_XHWACHA, "#N,#p,#v,#w,#d,#s",  MATCH_VFCVT_S_D | MASK_VRM, MASK_VFCVT_S_D | MASK_VRM, match_opcode,   0 },
{"vfcvt.s.d",   0, INSN_CLASS_XHWACHA, "#N,#p,#v,#w,#d,#s,#m",  MATCH_VFCVT_S_D, MASK_VFCVT_S_D, match_opcode,   0 },
{"vfclass.d",   0, INSN_CLASS_XHWACHA, "#N,#p,#v,#w,#d,#s",  MATCH_VFCLASS_D, MASK_VFCLASS_D, match_opcode,   0 },
{"vcmpfeq.d",   0, INSN_CLASS_XHWACHA, "#N,#p,#x,#F,#s,#t",    MATCH_VCMPFEQ_D, MASK_VCMPFEQ_D, match_opcode,  0 },
{"vcmpflt.d",   0, INSN_CLASS_XHWACHA, "#N,#p,#x,#F,#s,#t",    MATCH_VCMPFLT_D, MASK_VCMPFLT_D, match_opcode,  0 },
{"vcmpfle.d",   0, INSN_CLASS_XHWACHA, "#N,#p,#x,#F,#s,#t",    MATCH_VCMPFLE_D, MASK_VCMPFLE_D, match_opcode,  0 },
{"vcmpfgt.d",   0, INSN_CLASS_XHWACHA, "#N,#p,#x,#F,#t,#s",    MATCH_VCMPFLT_D, MASK_VCMPFLT_D, match_opcode,  0 },
{"vcmpfge.d",   0, INSN_CLASS_XHWACHA, "#N,#p,#x,#F,#t,#s",    MATCH_VCMPFLE_D, MASK_VCMPFLE_D, match_opcode,  0 },
{"vfcvt.w.d",   0, INSN_CLASS_XHWACHA, "#N,#p,#v,#w,#d,#s",     MATCH_VFCVT_W_D | MASK_VRM, MASK_VFCVT_W_D | MASK_VRM, match_opcode,  0 },
{"vfcvt.w.d",   0, INSN_CLASS_XHWACHA, "#N,#p,#v,#w,#d,#s,#m",  MATCH_VFCVT_W_D, MASK_VFCVT_W_D, match_opcode,  0 },
{"vfcvt.wu.d",  0, INSN_CLASS_XHWACHA, "#N,#p,#v,#w,#d,#s",     MATCH_VFCVT_WU_D | MASK_VRM, MASK_VFCVT_WU_D | MASK_VRM, match_opcode,  0 },
{"vfcvt.wu.d",  0, INSN_CLASS_XHWACHA, "#N,#p,#v,#w,#d,#s,#m",  MATCH_VFCVT_WU_D, MASK_VFCVT_WU_D, match_opcode,  0 },
{"vfcvt.d.w",   0, INSN_CLASS_XHWACHA, "#N,#p,#v,#w,#d,#s",     MATCH_VFCVT_D_W | MASK_VRM, MASK_VFCVT_D_W | MASK_VRM, match_opcode,   0 },
{"vfcvt.d.w",   0, INSN_CLASS_XHWACHA, "#N,#p,#v,#w,#d,#s,#m",  MATCH_VFCVT_D_W, MASK_VFCVT_D_W, match_opcode,   0 },
{"vfcvt.d.wu",  0, INSN_CLASS_XHWACHA, "#N,#p,#v,#w,#d,#s",     MATCH_VFCVT_D_WU | MASK_VRM, MASK_VFCVT_D_W | MASK_VRM, match_opcode,   0 },
{"vfcvt.d.wu",  0, INSN_CLASS_XHWACHA, "#N,#p,#v,#w,#d,#s,#m",  MATCH_VFCVT_D_WU, MASK_VFCVT_D_WU, match_opcode,   0 },
{"vfcvt.l.d",   0, INSN_CLASS_XHWACHA, "#N,#p,#v,#w,#d,#s",     MATCH_VFCVT_L_D | MASK_VRM, MASK_VFCVT_L_D | MASK_VRM, match_opcode,  0 },
{"vfcvt.l.d",   0, INSN_CLASS_XHWACHA, "#N,#p,#v,#w,#d,#s,#m",  MATCH_VFCVT_L_D, MASK_VFCVT_L_D, match_opcode,  0 },
{"vfcvt.lu.d",  0, INSN_CLASS_XHWACHA, "#N,#p,#v,#w,#d,#s",     MATCH_VFCVT_LU_D | MASK_VRM, MASK_VFCVT_LU_D | MASK_VRM, match_opcode,  0 },
{"vfcvt.lu.d",  0, INSN_CLASS_XHWACHA, "#N,#p,#v,#w,#d,#s,#m",  MATCH_VFCVT_LU_D, MASK_VFCVT_LU_D, match_opcode,  0 },
{"vfcvt.d.l",   0, INSN_CLASS_XHWACHA, "#N,#p,#v,#w,#d,#s",     MATCH_VFCVT_D_L | MASK_VRM, MASK_VFCVT_D_L | MASK_VRM, match_opcode,   0 },
{"vfcvt.d.l",   0, INSN_CLASS_XHWACHA, "#N,#p,#v,#w,#d,#s,#m",  MATCH_VFCVT_D_L, MASK_VFCVT_D_L, match_opcode,   0 },
{"vfcvt.d.lu",  0, INSN_CLASS_XHWACHA, "#N,#p,#v,#w,#d,#s",     MATCH_VFCVT_D_LU | MASK_VRM, MASK_VFCVT_D_L | MASK_VRM, match_opcode,   0 },
{"vfcvt.d.lu",  0, INSN_CLASS_XHWACHA, "#N,#p,#v,#w,#d,#s,#m",  MATCH_VFCVT_D_LU, MASK_VFCVT_D_LU, match_opcode,   0 },

/* Half-precision floating-point instruction subset */
{"vfsgnj.h",    0, INSN_CLASS_XHWACHA,   "#N,#p,#v,#x,#d,#s,#t",  MATCH_VFSGNJ_H, MASK_VFSGNJ_H, match_opcode,  0 },
{"vfsgnjn.h",   0, INSN_CLASS_XHWACHA,   "#N,#p,#v,#x,#d,#s,#t",  MATCH_VFSGNJN_H, MASK_VFSGNJN_H, match_opcode,  0 },
{"vfsgnjx.h",   0, INSN_CLASS_XHWACHA,   "#N,#p,#v,#x,#d,#s,#t",  MATCH_VFSGNJX_H, MASK_VFSGNJX_H, match_opcode,  0 },
{"vfadd.h",     0, INSN_CLASS_XHWACHA,   "#N,#p,#v,#x,#d,#s,#t",  MATCH_VFADD_H | MASK_VRM, MASK_VFADD_H | MASK_VRM, match_opcode,  0 },
{"vfadd.h",     0, INSN_CLASS_XHWACHA,   "#N,#p,#v,#x,#d,#s,#t,#m",  MATCH_VFADD_H, MASK_VFADD_H, match_opcode,  0 },
{"vfsub.h",     0, INSN_CLASS_XHWACHA,   "#N,#p,#v,#x,#d,#s,#t",  MATCH_VFSUB_H | MASK_VRM, MASK_VFSUB_H | MASK_VRM, match_opcode,  0 },
{"vfsub.h",     0, INSN_CLASS_XHWACHA,   "#N,#p,#v,#x,#d,#s,#t,#m",  MATCH_VFSUB_H, MASK_VFSUB_H, match_opcode,  0 },
{"vfmul.h",     0, INSN_CLASS_XHWACHA,   "#N,#p,#v,#x,#d,#s,#t",  MATCH_VFMUL_H | MASK_VRM, MASK_VFMUL_H | MASK_VRM, match_opcode,  0 },
{"vfmul.h",     0, INSN_CLASS_XHWACHA,   "#N,#p,#v,#x,#d,#s,#t,#m",  MATCH_VFMUL_H, MASK_VFMUL_H, match_opcode,  0 },
{"vfdiv.h",     0, INSN_CLASS_XHWACHA,   "#N,#p,#v,#x,#d,#s,#t",  MATCH_VFDIV_H | MASK_VRM, MASK_VFDIV_H | MASK_VRM, match_opcode,  0 },
{"vfdiv.h",     0, INSN_CLASS_XHWACHA,   "#N,#p,#v,#x,#d,#s,#t,#m",  MATCH_VFDIV_H, MASK_VFDIV_H, match_opcode,  0 },
{"vfsqrt.h",    0, INSN_CLASS_XHWACHA,   "#N,#p,#v,#w,#d,#s",  MATCH_VFSQRT_H | MASK_VRM, MASK_VFSQRT_H | MASK_VRM, match_opcode, 0 },
{"vfsqrt.h",    0, INSN_CLASS_XHWACHA,   "#N,#p,#v,#w,#d,#s,#m",  MATCH_VFSQRT_H, MASK_VFSQRT_H, match_opcode, 0 },
{"vfmin.h",     0, INSN_CLASS_XHWACHA,   "#N,#p,#v,#x,#d,#s,#t",  MATCH_VFMIN_H, MASK_VFMIN_H, match_opcode,  0 },
{"vfmax.h",     0, INSN_CLASS_XHWACHA,   "#N,#p,#v,#x,#d,#s,#t",  MATCH_VFMAX_H, MASK_VFMAX_H, match_opcode,  0 },
{"vfmadd.h",    0, INSN_CLASS_XHWACHA,   "#N,#p,#v,#y,#d,#s,#t,#r",  MATCH_VFMADD_H | MASK_VRM, MASK_VFMADD_H | MASK_VRM, match_opcode,  0 },
{"vfmadd.h",    0, INSN_CLASS_XHWACHA,   "#N,#p,#v,#y,#d,#s,#t,#r,#m",  MATCH_VFMADD_H, MASK_VFMADD_H, match_opcode,  0 },
{"vfnmadd.h",   0, INSN_CLASS_XHWACHA,   "#N,#p,#v,#y,#d,#s,#t,#r",  MATCH_VFNMADD_H | MASK_VRM, MASK_VFNMADD_H | MASK_VRM, match_opcode,  0 },
{"vfnmadd.h",   0, INSN_CLASS_XHWACHA,   "#N,#p,#v,#y,#d,#s,#t,#r,#m",  MATCH_VFNMADD_H, MASK_VFNMADD_H, match_opcode,  0 },
{"vfmsub.h",    0, INSN_CLASS_XHWACHA,   "#N,#p,#v,#y,#d,#s,#t,#r",  MATCH_VFMSUB_H | MASK_VRM, MASK_VFMSUB_H | MASK_VRM, match_opcode,  0 },
{"vfmsub.h",    0, INSN_CLASS_XHWACHA,   "#N,#p,#v,#y,#d,#s,#t,#r,#m",  MATCH_VFMSUB_H, MASK_VFMSUB_H, match_opcode,  0 },
{"vfnmsub.h",   0, INSN_CLASS_XHWACHA,   "#N,#p,#v,#y,#d,#s,#t,#r",  MATCH_VFNMSUB_H | MASK_VRM, MASK_VFNMSUB_H | MASK_VRM, match_opcode,  0 },
{"vfnmsub.h",   0, INSN_CLASS_XHWACHA,   "#N,#p,#v,#y,#d,#s,#t,#r,#m",  MATCH_VFNMSUB_H, MASK_VFNMSUB_H, match_opcode,  0 },
{"vfcvt.s.h",   0, INSN_CLASS_XHWACHA,   "#N,#p,#v,#w,#d,#s",  MATCH_VFCVT_S_H, MASK_VFCVT_S_H | MASK_VRM, match_opcode,  0 },
{"vfcvt.h.s",   0, INSN_CLASS_XHWACHA,   "#N,#p,#v,#w,#d,#s",  MATCH_VFCVT_H_S | MASK_VRM, MASK_VFCVT_H_S | MASK_VRM, match_opcode,  0 },
{"vfcvt.h.s",   0, INSN_CLASS_XHWACHA,   "#N,#p,#v,#w,#d,#s,#m",  MATCH_VFCVT_H_S, MASK_VFCVT_H_S, match_opcode,  0 },
{"vfcvt.d.h",   0, INSN_CLASS_XHWACHA,   "#N,#p,#v,#w,#d,#s",  MATCH_VFCVT_D_H, MASK_VFCVT_D_H | MASK_VRM, match_opcode,  0 },
{"vfcvt.h.d",   0, INSN_CLASS_XHWACHA,   "#N,#p,#v,#w,#d,#s",  MATCH_VFCVT_H_D | MASK_VRM, MASK_VFCVT_H_D | MASK_VRM, match_opcode,  0 },
{"vfcvt.h.d",   0, INSN_CLASS_XHWACHA,   "#N,#p,#v,#w,#d,#s,#m",  MATCH_VFCVT_H_D, MASK_VFCVT_H_D, match_opcode,  0 },
{"vcmpfeq.h",   0, INSN_CLASS_XHWACHA,   "#N,#p,#x,#F,#s,#t",    MATCH_VCMPFEQ_H, MASK_VCMPFEQ_H, match_opcode, 0 },
{"vcmpflt.h",   0, INSN_CLASS_XHWACHA,   "#N,#p,#x,#F,#s,#t",    MATCH_VCMPFLT_H, MASK_VCMPFLT_H, match_opcode, 0 },
{"vcmpfle.h",   0, INSN_CLASS_XHWACHA,   "#N,#p,#x,#F,#s,#t",    MATCH_VCMPFLE_H, MASK_VCMPFLE_H, match_opcode, 0 },
{"vcmpfgt.h",   0, INSN_CLASS_XHWACHA,   "#N,#p,#x,#F,#t,#s",    MATCH_VCMPFLT_H, MASK_VCMPFLT_H, match_opcode, 0 },
{"vcmpfge.h",   0, INSN_CLASS_XHWACHA,   "#N,#p,#x,#F,#t,#s",    MATCH_VCMPFLE_H, MASK_VCMPFLE_H, match_opcode, 0 },
{"vfcvt.w.h",   0, INSN_CLASS_XHWACHA,   "#N,#p,#v,#w,#d,#s",     MATCH_VFCVT_W_H | MASK_VRM, MASK_VFCVT_W_H | MASK_VRM, match_opcode,  0 },
{"vfcvt.w.h",   0, INSN_CLASS_XHWACHA,   "#N,#p,#v,#w,#d,#s,#m",  MATCH_VFCVT_W_H, MASK_VFCVT_W_H, match_opcode,  0 },
{"vfcvt.wu.h",  0, INSN_CLASS_XHWACHA,   "#N,#p,#v,#w,#d,#s",     MATCH_VFCVT_WU_H | MASK_VRM, MASK_VFCVT_WU_H | MASK_VRM, match_opcode,  0 },
{"vfcvt.wu.h",  0, INSN_CLASS_XHWACHA,   "#N,#p,#v,#w,#d,#s,#m",  MATCH_VFCVT_WU_H, MASK_VFCVT_WU_H, match_opcode,  0 },
{"vfcvt.h.w",   0, INSN_CLASS_XHWACHA,   "#N,#p,#v,#w,#d,#s",     MATCH_VFCVT_H_W | MASK_VRM, MASK_VFCVT_H_W | MASK_VRM, match_opcode,   0 },
{"vfcvt.h.w",   0, INSN_CLASS_XHWACHA,   "#N,#p,#v,#w,#d,#s,#m",  MATCH_VFCVT_H_W, MASK_VFCVT_H_W, match_opcode,   0 },
{"vfcvt.h.wu",  0, INSN_CLASS_XHWACHA,   "#N,#p,#v,#w,#d,#s",     MATCH_VFCVT_H_WU | MASK_VRM, MASK_VFCVT_H_W | MASK_VRM, match_opcode,   0 },
{"vfcvt.h.wu",  0, INSN_CLASS_XHWACHA,   "#N,#p,#v,#w,#d,#s,#m",  MATCH_VFCVT_H_WU, MASK_VFCVT_H_WU, match_opcode,   0 },
{"vfcvt.l.h",   0, INSN_CLASS_XHWACHA,   "#N,#p,#v,#w,#d,#s",     MATCH_VFCVT_L_H | MASK_VRM, MASK_VFCVT_L_H | MASK_VRM, match_opcode,  0 },
{"vfcvt.l.h",   0, INSN_CLASS_XHWACHA,   "#N,#p,#v,#w,#d,#s,#m",  MATCH_VFCVT_L_H, MASK_VFCVT_L_H, match_opcode,  0 },
{"vfcvt.lu.h",  0, INSN_CLASS_XHWACHA,   "#N,#p,#v,#w,#d,#s",     MATCH_VFCVT_LU_H | MASK_VRM, MASK_VFCVT_LU_H | MASK_VRM, match_opcode,  0 },
{"vfcvt.lu.h",  0, INSN_CLASS_XHWACHA,   "#N,#p,#v,#w,#d,#s,#m",  MATCH_VFCVT_LU_H, MASK_VFCVT_LU_H, match_opcode,  0 },
{"vfcvt.h.l",   0, INSN_CLASS_XHWACHA,   "#N,#p,#v,#w,#d,#s",     MATCH_VFCVT_H_L | MASK_VRM, MASK_VFCVT_H_L | MASK_VRM, match_opcode,   0 },
{"vfcvt.h.l",   0, INSN_CLASS_XHWACHA,   "#N,#p,#v,#w,#d,#s,#m",  MATCH_VFCVT_H_L, MASK_VFCVT_H_L, match_opcode,   0 },
{"vfcvt.h.lu",  0, INSN_CLASS_XHWACHA,   "#N,#p,#v,#w,#d,#s",     MATCH_VFCVT_H_LU | MASK_VRM, MASK_VFCVT_H_L | MASK_VRM, match_opcode,   0 },
{"vfcvt.h.lu",  0, INSN_CLASS_XHWACHA,   "#N,#p,#v,#w,#d,#s,#m",  MATCH_VFCVT_H_LU, MASK_VFCVT_H_LU, match_opcode,   0 },

/* Mixed-precision floating-point instruction subset */
{"vfadd.s.h",     0, INSN_CLASS_XHWACHA,   "#N,#p,#v,#x,#d,#s,#t",  MATCH_VFADD_S_H | MASK_VRM, MASK_VFADD_S_H | MASK_VRM, match_opcode,  0 },
{"vfadd.s.h",     0, INSN_CLASS_XHWACHA,   "#N,#p,#v,#x,#d,#s,#t,#m",  MATCH_VFADD_S_H, MASK_VFADD_S_H, match_opcode,  0 },
{"vfsub.s.h",     0, INSN_CLASS_XHWACHA,   "#N,#p,#v,#x,#d,#s,#t",  MATCH_VFSUB_S_H | MASK_VRM, MASK_VFSUB_S_H | MASK_VRM, match_opcode,  0 },
{"vfsub.s.h",     0, INSN_CLASS_XHWACHA,   "#N,#p,#v,#x,#d,#s,#t,#m",  MATCH_VFSUB_S_H, MASK_VFSUB_S_H, match_opcode,  0 },
{"vfmul.s.h",     0, INSN_CLASS_XHWACHA,   "#N,#p,#v,#x,#d,#s,#t",  MATCH_VFMUL_S_H | MASK_VRM, MASK_VFMUL_S_H | MASK_VRM, match_opcode,  0 },
{"vfmul.s.h",     0, INSN_CLASS_XHWACHA,   "#N,#p,#v,#x,#d,#s,#t,#m",  MATCH_VFMUL_S_H, MASK_VFMUL_S_H, match_opcode,  0 },
{"vfadd.d.h",     0, INSN_CLASS_XHWACHA,   "#N,#p,#v,#x,#d,#s,#t",  MATCH_VFADD_D_H | MASK_VRM, MASK_VFADD_D_H | MASK_VRM, match_opcode,  0 },
{"vfadd.d.h",     0, INSN_CLASS_XHWACHA,   "#N,#p,#v,#x,#d,#s,#t,#m",  MATCH_VFADD_D_H, MASK_VFADD_D_H, match_opcode,  0 },
{"vfsub.d.h",     0, INSN_CLASS_XHWACHA,   "#N,#p,#v,#x,#d,#s,#t",  MATCH_VFSUB_D_H | MASK_VRM, MASK_VFSUB_D_H | MASK_VRM, match_opcode,  0 },
{"vfsub.d.h",     0, INSN_CLASS_XHWACHA,   "#N,#p,#v,#x,#d,#s,#t,#m",  MATCH_VFSUB_D_H, MASK_VFSUB_D_H, match_opcode,  0 },
{"vfmul.d.h",     0, INSN_CLASS_XHWACHA,   "#N,#p,#v,#x,#d,#s,#t",  MATCH_VFMUL_D_H | MASK_VRM, MASK_VFMUL_D_H | MASK_VRM, match_opcode,  0 },
{"vfmul.d.h",     0, INSN_CLASS_XHWACHA,   "#N,#p,#v,#x,#d,#s,#t,#m",  MATCH_VFMUL_D_H, MASK_VFMUL_D_H, match_opcode,  0 },
{"vfmadd.d.h",    0, INSN_CLASS_XHWACHA,   "#N,#p,#v,#y,#d,#s,#t,#r",  MATCH_VFMADD_D_H | MASK_VRM, MASK_VFMADD_D_H | MASK_VRM, match_opcode,  0 },
{"vfmadd.d.h",    0, INSN_CLASS_XHWACHA,   "#N,#p,#v,#y,#d,#s,#t,#r,#m",  MATCH_VFMADD_D_H, MASK_VFMADD_D_H, match_opcode,  0 },
{"vfnmadd.d.h",   0, INSN_CLASS_XHWACHA,   "#N,#p,#v,#y,#d,#s,#t,#r",  MATCH_VFNMADD_D_H | MASK_VRM, MASK_VFNMADD_D_H | MASK_VRM, match_opcode,  0 },
{"vfnmadd.d.h",   0, INSN_CLASS_XHWACHA,   "#N,#p,#v,#y,#d,#s,#t,#r,#m",  MATCH_VFNMADD_D_H, MASK_VFNMADD_D_H, match_opcode,  0 },
{"vfmsub.d.h",    0, INSN_CLASS_XHWACHA,   "#N,#p,#v,#y,#d,#s,#t,#r",  MATCH_VFMSUB_D_H | MASK_VRM, MASK_VFMSUB_D_H | MASK_VRM, match_opcode,  0 },
{"vfmsub.d.h",    0, INSN_CLASS_XHWACHA,   "#N,#p,#v,#y,#d,#s,#t,#r,#m",  MATCH_VFMSUB_D_H, MASK_VFMSUB_D_H, match_opcode,  0 },
{"vfnmsub.d.h",   0, INSN_CLASS_XHWACHA,   "#N,#p,#v,#y,#d,#s,#t,#r",  MATCH_VFNMSUB_D_H | MASK_VRM, MASK_VFNMSUB_D_H | MASK_VRM, match_opcode,  0 },
{"vfnmsub.d.h",   0, INSN_CLASS_XHWACHA,   "#N,#p,#v,#y,#d,#s,#t,#r,#m",  MATCH_VFNMSUB_D_H, MASK_VFNMSUB_D_H, match_opcode,  0 },
{"vfadd.d.s",     0, INSN_CLASS_XHWACHA,   "#N,#p,#v,#x,#d,#s,#t",  MATCH_VFADD_D_S | MASK_VRM, MASK_VFADD_D_S | MASK_VRM, match_opcode,  0 },
{"vfadd.d.s",     0, INSN_CLASS_XHWACHA,   "#N,#p,#v,#x,#d,#s,#t,#m",  MATCH_VFADD_D_S, MASK_VFADD_D_S, match_opcode,  0 },
{"vfsub.d.s",     0, INSN_CLASS_XHWACHA,   "#N,#p,#v,#x,#d,#s,#t",  MATCH_VFSUB_D_S | MASK_VRM, MASK_VFSUB_D_S | MASK_VRM, match_opcode,  0 },
{"vfsub.d.s",     0, INSN_CLASS_XHWACHA,   "#N,#p,#v,#x,#d,#s,#t,#m",  MATCH_VFSUB_D_S, MASK_VFSUB_D_S, match_opcode,  0 },
{"vfmul.d.s",     0, INSN_CLASS_XHWACHA,   "#N,#p,#v,#x,#d,#s,#t",  MATCH_VFMUL_D_S | MASK_VRM, MASK_VFMUL_D_S | MASK_VRM, match_opcode,  0 },
{"vfmul.d.s",     0, INSN_CLASS_XHWACHA,   "#N,#p,#v,#x,#d,#s,#t,#m",  MATCH_VFMUL_D_S, MASK_VFMUL_D_S, match_opcode,  0 },
